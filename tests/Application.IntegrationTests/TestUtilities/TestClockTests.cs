namespace Application.IntegrationTests.TestUtilities;
...
public class TestClockTests
{
    ...
    public void TestClock_GetTime_Returns_DefaultTime()
    {
        ...
        Assert.Equal(TestClock.DefaultTime, target.GetTime());
    }
    ...
    public void TestClock_GetTime_Returns_GivenTime()
    {
        ...
        Assert.Equal(time, target.GetTime());
    }
    ...
    public void TestClock_Tick_DefaultIncrement_IsOneSecond()
    {
        ...
        Assert.Equal(TimeSpan.FromSeconds(1), t2 - t1);
    }
    ...
    public void TestClock_Adjust_SetsTime()
    {
        ...
        Assert.Equal(timespan, t2 - t1);
        Assert.Equal(t1.Add(timespan), r);
    }
    ...
    public void TestClock_GetDeterministicRandomTime_IsDeterministic()
    {
        ...
        Assert.Equal(TestClock.GetDeterministicRandomTime(), TestClock.GetDeterministicRandomTime());
        Assert.Equal(TestClock.GetDeterministicRandomTime("A"), TestClock.GetDeterministicRandomTime("A"));

        // Each invocation from different methods should (likely) return the different values
        Assert.NotEqual(GetTime1(), GetTime2());
        Assert.NotEqual(TestClock.GetDeterministicRandomTime("A"), TestClock.GetDeterministicRandomTime("B"));
    }
    ...
    public void TestClock_TestVector()  // Do not change method name or fix expected value when you do
    {
        ...
        Assert.Equal(expected, TestClock.GetDeterministicRandomTime());
    ...
    public void TestClock_GetDeterministicRandomTime_UsesGivenOffset()
    {
        ...
        Assert.Equal(offset, TestClock.GetDeterministicRandomTime(offset).Offset);
    }
